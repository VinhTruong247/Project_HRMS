...
VALUES
  ('JB000001', 'Software Engineer', N'Trách nhiệm phát triển ứng dụng phần mềm', '2023-01-01', 1, 1000000.00, 'AL000001', 100000000.00),
  ('JB000002', 'Data Analyst', N'Phân tích dữ liệu và cung cấp thông tin', '2023-02-01',1, 900000.00, 'AL000002', 80000000.00),
  ('JB000003', 'Network Administrator', N'Quản lý và duy trì cơ sở hạ tầng mạng', '2023-03-01',1, 1100000.00, 'AL000003', 120000000.00),
  ('JB000004', 'Web Developer', N'Trách nhiệm thiết kế và phát triển website', '2023-04-01',1, 800000.00, 'AL000004', 60000000.00),
  ('JB000005', 'IT Project Manager', N'Lập kế hoạch, thực hiện và quản lý dự án IT', '2023-05-01',1, 1200000.00, 'AL000005', 140000000.00),
  ('JB000006', 'Database Administrator', N'Quản lý và duy trì cơ sở dữ liệu', '2023-06-01',1, 1000000.00, 'AL000006', 100000000.00),
  ('JB000007', 'Quality Assurance Engineer', N'Đảm bảo chất lượng phần mềm qua kiểm thử và phân tích', '2023-07-01', 1, 900000.00, 'AL000007', 80000000.00),
  ('JB000008', 'System Analyst', N'Phân tích và cải thiện hệ thống thông tin của công ty', '2023-08-01', 1, 1100000.00, 'AL000008', 120000000.00),
  ('JB000009', 'UI/UX Designer', N'Thiết kế giao diện người dùng và trải nghiệm người dùng', '2023-09-01', 1, 800000.00, 'AL000009', 60000000.00),
  ('JB000010', 'IT Support Specialist', N'Cung cấp hỗ trợ kỹ thuật cho người dùng cuối', '2023-10-01', 1, 1000000.00, 'AL000010', 100000000.00),
  ('JB000011', 'Business Analyst', N'Phân tích nhu cầu và xác định yêu cầu kinh doanh', '2023-11-01', 1, 950000.00, 'AL000007', 90000000.00),
  ('JB000012', 'IT Consultant', N'Tư vấn và đề xuất giải pháp công nghệ thông tin', '2023-12-01', 1, 1050000.00, 'AL000002', 110000000.00),
  ('JB000013', 'Cybersecurity Analyst', N'Phân tích và đảm bảo an ninh thông tin', '2024-01-01',1, 950000.00, 'AL000006', 90000000.00);
